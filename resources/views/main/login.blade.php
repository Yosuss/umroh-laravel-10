    ...
    <div class="login w-full">
        <div class="grid grid-cols-2 h-screen max-md:grid-cols-1">
            ...
            <div class="flex flex-col items-center justify-center text-center md:mx-20">
                ...
                <h1 class="text-xl lg:text-xl font-light mt-4 lg:mt-6 w-10/12 lg:w-8/12">Sign In untuk mengelola dan memantau semua data
                    ...
                    <form action="{{ route('login') }}" method="POST" class="flex flex-col items-center lg:items-start lg:mt-6">
                        @csrf
                        <label for="" class="flex mt-2 text-2xl self-start font-light mb-2">Username</label>
                        ...
                        <label for="" class="flex mt-2 text-2xl self-start font-light mb-2">Password</label>
                        ...
                        <button type="submit" class="capitalize bg-blue-800 px-4 py-4 text-white mt-8 rounded-xl text-2xl w-[30rem] lg:w-[35rem]">sign in</button>
                    </form>
            </div>
        </div>
    </div>
